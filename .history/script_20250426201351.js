const stands = {
  flecha: [
    ...
    { nome: "Gold Experience Requiem", peso: 155, especial: true },
    { nome: "The World", peso: 0, },
    { nome: "King Crimson", peso: 0, especial: true },
    { nome: "Red Hot Chili Pepper", peso: 0 },
    { nome: "The Hand", peso: 0 },
    { nome: "Cream", peso: 0 },
    { nome: "Hierophant Green", peso: 0 },
    { nome: "Magician's Red", peso: 0, },
    { nome: "Anubis", peso: 0,  },
    { nome: "Heaven's Door", peso: 0, },
    { nome: "Sticky Fingers", peso: 0, },
    { nome: "Chariot Requiem", peso: 155,especial: true },
    { nome: "Metallica", peso: 0, },
    { nome: "Purple Haze", peso: 0, },
    { nome: "Weather Report", peso:0 , },
    { nome: "Whitesnake", peso: 0, },
    { nome: "C-MOON", peso: 0, },
    { nome: "Made in Heaven", peso: 155, especial:true },
  ...
  cadaver: [
    ...
    { nome: "Scary Monsters", peso: 0, },
    { nome: "Catch the Rainbow", peso: 115, especial: true },
    { nome: "Cream Starter", peso: 0,  },
    { nome: "Killer Queen - Alternativo", peso: 5 },
    { nome: "November Rain", peso: 0 },
