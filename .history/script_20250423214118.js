...
function escolher(tipo) {
  ...
  firebase.database().ref('users/' + userId).once('value').then(snapshot => {
    ...
    // Se nada foi escolhido (tudo com peso 0), pega aleatoriamente
    if (!escolhido) {
    ...
    switch (escolhido.nome) {
      case "Gold Experience Requiem":
        videoPath = "videos/ger-animation.mp4"; break;
      case "Tusk ACT4":
        videoPath = "videos/tusk.mp4"; break;
      case "D4C":
        videoPath = "videos/d4c.mp4"; break;
      case "The World - Alternativo":
        videoPath = "videos/world.mp4"; break;
      case "Killer Queen":
        videoPath = "videos/queen.mp4"; break;
      case "Wonder of U":
        videoPath = "videos/wonder.mp4"; break;
      case "King Crimson":
        videoPath = "videos/king.mp4"; break;
    }
