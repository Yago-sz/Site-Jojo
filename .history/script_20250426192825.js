const stands = {
  flecha: [
    ...
    { nome: "Magician's Red", peso: 10, especial: true },
    { nome: "Anubis", peso: 10,  },
    { nome: "Heaven's Door", peso: 10, },
    { nome: "Sticky Fingers", peso: 10, },
    { nome: "Chariot Requiem", peso: 10,especial: true },
    { nome: "Metallica", peso: 10, },
    { nome: "Purple Haze", peso: 10, },
    { nome: "Weather Report", peso: 10, },
    { nome: "Whitesnake", peso: 10, },
    { nome: "C-MOON", peso: 10, },
    { nome: "Made in Heaven", peso: 10, especial:true },
  ...
  cadaver: [
    ...
    { nome: "Ball Breaker", peso: 10, especial: true },
    { nome: "Scary Monsters", peso: 10, especial: true },
    { nome: "Catch the Rainbow", peso: 10, especial: true },
    { nome: "Cream Starter", peso: 10, especial: true },
    { nome: "Mandom", peso: 0 },
    { nome: "Killer Queen - Alternativo", peso: 0 },
