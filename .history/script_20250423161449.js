...
function escolher(tipo) {
  ...
  if (escolhido.especial) {
      ...
      // Ativar animações de brilho e tremor
      const animacaoBrilho = document.getElementById("animacao-brilho");
      const animacaoTremor = document.getElementById("animacao-tremor");
      animacaoBrilho.classList.add("active");
      animacaoTremor.classList.add("active");
      ...
      // Exibe o vídeo
      animacaoStand.style.display = "visible";
      animacaoStand.load();  // Recarrega o vídeo

      // Remover animação após o tempo do vídeo
      animacaoStand.onloadedmetadata = () => {
          ...
          setTimeout(() => {
              ...
              animacaoBrilho.classList.remove("active");
              animacaoTremor.classList.remove("active");
          }, duracao);
      };
  } else {
      // Se não for especial, pode ter uma animação padrão ou nenhum efeito
      // Exemplo de animação padrão
      const animacao = document.getElementById("animacao-padrao");
      animacao.classList.add("active");
  }
}