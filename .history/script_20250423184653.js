const stands = {
  flecha: [
    { nome: "Star Platinum", peso: 15 },
    { nome: "Killer Queen", peso: 15, especial: true },
    { nome: "Crazy Diamond", peso: 15 },
    { nome: "Gold Experience Requiem", peso: 15, especial: true },
    { nome: "The World", peso: 15, especial: true }
  ],
  cadaver: [
    { nome: "Tusk ACT4", peso: 15, especial: true },
    { nome: "D4C - Love Train", peso: 15, especial: true },
    { nome: "Soft & Wet", peso: 15 },
    { nome: "Wonder of U", peso: 15, especial: true },
    { nome: "The World Over Heaven", peso: 15, especial: true }
  ]
};
